package com.blogger.blog.controllers;
...
public class CategoryController {
	...
	public ResponseEntity<ApiResponse> deleteCategory(@PathVariable Integer catId){
		...
		return new ResponseEntity<ApiResponse>(new ApiResponse("category deleted succesfull",true),HttpStatus.OK);
	}
	//get
	@GetMapping("/{catId}")
	public ResponseEntity<CategoryDto> getCategory(@PathVariable Integer catId){
		
		CategoryDto createCategory=this.categoryService.getCategory(catId);
